...
describe('SwapContract', () => {
    ...
    beforeEach(async () => {
        ...
        swapContract = blockchain.openContract(
    ...
    it('should increase counter', async () => {
        ...
        for (let i = 0; i < increaseTimes; i++) {
            ...
            const increaseResult = await swapContract.sendIncrease(increaser.getSender(), {
                increaseBy,
                value: toNano('0.05'),
            });
            ...
            const counterAfter = await swapContract.getCounter();
