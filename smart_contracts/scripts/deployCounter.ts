...
export async function run() {
    ...
    const mnemonic = "holiday base harsh pig tobacco van vast ocean bottom sniff carry effort mandate cover skull reopen cattle use riot input earn seven depart resemble"; // your 24 secret words (replace ... with the rest of the words)
